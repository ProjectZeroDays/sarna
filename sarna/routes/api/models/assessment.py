...
from sarna.routes.api.models.assessment_status import AssessmentStatus  # noqa: F401,E501
...
class Assessment(Model):
    ...
    @type.setter
    def type(self, type: AssessmentType):
    ...
    @status.setter
    def status(self, status: AssessmentStatus):
